...
def main():
	...
	for fname in os.listdir("./output/"):
		...
		for i in range(0, len(filters), 1):
			...
			if len(bluecnts)>0:
				...
				for (i, c) in enumerate(bluecnts):
					...
					try:
						...
						#print("File is corrupted... Passing " + filename)
						pass
					...
					try:
						...
						#print("Tried to write to file but failed") #This should NOT happen
						pass
			...
			'''
	bar.finish();
print("PROCESS COMPLETE -> Results appear in the \'final\' folder")
